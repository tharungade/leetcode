...
has for all index i (0&lt;=i&lt;N-1), if S[i]!='?', then S[i]!=S[i+1].</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
S = "abca" has for all index i (0&lt;=i&lt;N-1), if S[i]!='?', then S[i]!=S[i+1].</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
