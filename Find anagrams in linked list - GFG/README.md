...
<pre style="position: relative;"><strong><span style="font-size:18px"><span style="color:#000000">Input: </span></span></strong><span style="font-size:18px"><span style="color:#000000">a -&gt; b -&gt; d -&gt; c -&gt; a</span></span><strong><span style="font-size:18px"><span style="color:#000000">
